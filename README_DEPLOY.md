...
## 모바일 최적화 업데이트
- 360~430px 폭에서 메인/서브 페이지 레이아웃 보정
- 이용절차 제목/설명 세로 찌그러짐 수정
- 시설 카드, 요금표, 예약 CTA, 고정 하단 도크 모바일 보정
- 블로그 템플릿에 모바일 햄버거 메뉴 추가
- iPhone safe-area 대응을 위해 viewport-fit=cover 적용
